...
import { EndpointClientConfig, HttpClientParams } from '../endpoint-client';
import { LocaleReference, Status } from '../types';
export declare enum CapabilitySchemaPropertyName {
    VALUE = "value",
    UNIT = "unit",
    DATA = "data"
}
export declare enum CustomCapabilityStatus {
    PROPOSED = "proposed",
    LIVE = "live",
...
export interface CapabilityUpdate {
     ...
     */
    attributes?: {
        [name: string]: CapabilityAttribute;
    };
    /**
...
export declare enum CapabilityPresentationOperator {
    CONTAINS = "CONTAINS",
...
export interface CapabilityLocalizationArguments {
     ...
     */
    i18n?: {
        [key: string]: CapabilityLocalizationI18n;
    };
    /**
...
export interface CapabilityLocalizationCommands {
     ...
     */
    arguments?: {
        [key: string]: CapabilityLocalizationArguments;
    };
}
...
export interface CapabilityLocalization {
     ...
     */
    attributes?: {
        [key: string]: CapabilityLocalizationAttributes;
    };
    /**
     * Map of command name to localizations
     */
    commands?: {
        [key: string]: CapabilityLocalizationCommands;
    };
}
export declare class CapabilitiesEndpoint extends Endpoint {
    constructor(config: EndpointClientConfig);
    /**
     * Get a list of custom capabilities for the given namespace.
     */
    list(namespace: string): Promise<CapabilitySummary[]>;
    listNamespaces(): Promise<CapabilityNamespace[]>;
    /**
     * Gets a list of standard capabilities.
     */
    listStandard(): Promise<CapabilitySummary[]>;
    listVersions(capabilityId: string): Promise<CapabilitySummary[]>;
    get(capabilityId: string, capabilityVersion: number): Promise<Capability>;
    create(capability: CapabilityCreate, params?: HttpClientParams): Promise<Capability>;
    update(capabilityId: string, capabilityVersion: number, capability: CapabilityUpdate): Promise<Capability>;
    delete(capabilityId: string, capabilityVersion: number): Promise<Status>;
    getPresentation(capabilityId: string, capabilityVersion: number): Promise<CapabilityPresentation>;
    createPresentation(capabilityId: string, capabilityVersion: number, presentation: CapabilityPresentationCreate): Promise<CapabilityPresentation>;
    updatePresentation(capabilityId: string, capabilityVersion: number, presentation: CapabilityPresentationUpdate): Promise<CapabilityPresentation>;
    /**
     ...
     */
    listLocales(capabilityId: string, capabilityVersion: number): Promise<LocaleReference[]>;
    /**
     *
     ...
     * @param capabilityVersion version number of the capability, starting with 1
     */
    getTranslations(capabilityId: string, capabilityVersion: number, tag: string): Promise<CapabilityLocalization>;
    /**
     ...
     */
    createTranslations(capabilityId: string, capabilityVersion: number, data: CapabilityLocalization): Promise<CapabilityLocalization>;
    /**
     ...
     * @param data translations
     */
    updateTranslations(capabilityId: string, capabilityVersion: number, data: CapabilityLocalization): Promise<CapabilityLocalization>;
    /**
     ...
     * @param data translations
     */
    upsertTranslations(capabilityId: string, capabilityVersion: number, data: CapabilityLocalization): Promise<CapabilityLocalization>;
    /**
     ...
     * @param tag locale tag, e.g. 'en', 'es', or 'ko'
     */
    deleteTranslations(capabilityId: string, capabilityVersion: number, tag: string): Promise<Status>;
}
