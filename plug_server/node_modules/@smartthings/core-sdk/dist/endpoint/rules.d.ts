...
export declare enum ConditionAggregationMode {
    Any = "Any",
    All = "All"
}
...
export declare enum OperandAggregationMode {
    None = "None",
    Avg = "Avg",
    Sum = "Sum",
    Min = "Min",
...
export declare class MapOperand extends null<string, Operand> {
}
...
export declare enum LocationAttribute {
    Mode = "Mode",
    ArmState = "ArmState"
}
...
export declare class RulesEndpoint extends Endpoint {
     ...
     * can be omitted
     */
    execute(id: string, locationId?: string): Promise<Status>;
}
