...
class DevicesEndpoint extends endpoint_1.Endpoint {
    ...
    create(definition) {
        ...
        if (definition.app) {
            data = {
                ...
                app: Object.assign({ installedAppId: this.installedAppId() }, definition.app),
            };
        }
    ...
    executeCommands(id, commands) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.client.post(`${id}/commands`, { commands });
    ...
    executeCommand(id, command) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.executeCommands(id, [command]);
            return types_1.SuccessStatusValue;
        });
    }
    /**
    ...
    sendCommand(item, capabilityIdOrCmdList, command, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (deviceConfig) {
                ...
                const body = { commands };
                yield this.client.post(`${deviceConfig.deviceId}/commands`, body);
                return types_1.SuccessStatusValue;
            }
